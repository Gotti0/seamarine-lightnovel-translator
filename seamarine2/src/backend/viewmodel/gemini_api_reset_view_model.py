...
class GeminiApiResetViewModel(QObject):
    ...
    geminiApiKeysChanged = Signal()
    @Property('QVariantList', notify=geminiApiKeysChanged)
    def geminiApiKeys(self):
        return self._config_data.gemini_api_keys
